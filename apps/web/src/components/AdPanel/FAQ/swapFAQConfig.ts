...
export const swapFAQConfig: FAQConfig = [
  ...
  },
  {
    ...
    content:
      'To swap tokens on PancakeSwap, connect your wallet, select the tokens you want to trade, enter the amount, and confirm the transaction. Ensure you check slippage tolerance to avoid failed transactions.',
  },
  {
    title: 'What is Slippage in Swapping?',
    content:
